# Media Team — Services + Knowledge Base

Стек: Vanilla HTML/CSS/JS (ES Modules) + SPA router.
...
- Пример: `npx serve -s .` и открыть выданный адрес.

Структура
- /core — дизайн-система и компоненты
- /shared — общая логика, API, роутер
- /pages — страницы
